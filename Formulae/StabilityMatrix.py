...
def K0(sol_backg,params):
    ...
    return np.array([[0.,0.,omega0_inv,0.],[2*l0*r0_m3*omega0_m2,0.,0.,-r0_m2*omega0_m2],[-r0_m3*omega0_inv,0.,0.,-2*l0*r0_m3*omega0_inv],[0.,0.,0.,0.]])
...
def K1(sol_backg,params):
    ...
    r0_m2 = r0_inv*r0_inv
    r0_m3 = r0_inv*r0_m2
    K1_pr = omega0_inv*(ddpsi + 2*l0*r0_m3*omega0_inv*dpsi)
    K1_lr = -m*omega0_inv*(dpsi + 2*l0*r0_m3*omega0_inv*psi)
...
def K3(sol_pert,sol_backg,params):
    ...
    K3_pr = -r0_m3*omega0_inv*(-omega1_norm + 6*l1_norm - 6*r1_norm) + 2*l0*r0_m5*omega0_m2*(2*l1_norm -r1_norm)
...
def K(params):
    ...
    mat = K0(sol_backg,params)
    
    for m in range(mmin,mmax):
        new_params = [params[0],params[1],m]
        r1 , l1 = sol.r_m(new_params) , sol.l_m(new_params)
